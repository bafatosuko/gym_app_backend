package gr.myproject.wod_core_backend.security;


import gr.myproject.wod_core_backend.authentication.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers("/api/customers/**").hasAnyAuthority(Role.CUSTOMER.name())
                        .requestMatchers("/api/trainers/**").hasAnyAuthority(Role.TRAINER.name(), Role.ADMIN.name())
