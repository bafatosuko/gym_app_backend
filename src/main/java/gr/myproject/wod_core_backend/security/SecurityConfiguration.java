    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .hasAnyAuthority(Role.CUSTOMER.name(), Role.TRAINER.name(), Role.ADMIN.name())
                        .requestMatchers("/api/users/trainers/**").hasAnyAuthority(Role.TRAINER.name(), Role.ADMIN.name())
